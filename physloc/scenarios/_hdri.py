...
HDRI_IDS: List[str] = [
    ...
    "colorful_studio", "de_balie", "derelict_underpass",
    "empty_warehouse_01", "graffiti_shelter", "hansaplatz", "hotel_room",
    "industrial_pipe_and_valve_01", "killesberg_park", "lebombo",
    "lythwood_room", "museum_of_ethnography", "old_bus_depot",
    "paul_lobe_haus", "photo_studio_01", "reading_room", "royal_esplanade",
    "shanghai_bund", "st_fagans_interior", "studio_small_03", "surgery",
    "teufelsberg_lookout", "urban_alley_01", "vulture_hide",
    "wooden_lounge"
]
